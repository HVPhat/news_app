              ...
              <form action="{{ route('post.store') }}" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="chu_de" id="exampleInputTopic" placeholder="Topic">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputImages">Hình ảnh</label>
                    <input type="text" class="form-control" name="hinh_anh" id="exampleInputImages" placeholder="Images">
                  </div>
                  <div class="form-group">
